...
def getUnrealProjectRoot():
    ...
    with open(active_project_config_path) as j:
        ...
        return os.path.dirname(json_data["programs"]["ue4"]["project_path"])
...
startup_script = os.path.join(tools_library_path, "programs\\ue4\\scripts\\install\\scripts\\startup.py")
